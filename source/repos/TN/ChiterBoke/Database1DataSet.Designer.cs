...
namespace ChiterBoke {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(int id, string Имя, string Телефон, string Имейл) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string Имейл {
                get {
                    try {
                        return ((string)(this[this.tableTable.ИмейлColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Имейл\' в таблице \'Table\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.ИмейлColumn] = value;
                }
            }
            ...
            public bool IsИмейлNull() {
                return this.IsNull(this.tableTable.ИмейлColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetИмейлNull() {
                this[this.tableTable.ИмейлColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace ChiterBoke.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([id] = @Original_id) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Телефон = 1 AND [Телефон] IS NULL) OR ([Телефон] = @Original_Телефон)) AND ((@IsNull_Имейл = 1 AND [Имейл] IS NULL) OR ([Имейл] = @Original_Имейл)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([id], [Имя], [Телефон], [Имейл]) VALUES (@id, @Имя, @Т" +
                "елефон, @Имейл);\r\nSELECT id, Имя, Телефон, Имейл FROM [Table] WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [id] = @id, [Имя] = @Имя, [Телефон] = @Телефон, [Имейл] = @Имейл WHERE (([id] = @Original_id) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Телефон = 1 AND [Телефон] IS NULL) OR ([Телефон] = @Original_Телефон)) AND ((@IsNull_Имейл = 1 AND [Имейл] IS NULL) OR ([Имейл] = @Original_Имейл)));
SELECT id, Имя, Телефон, Имейл FROM [Table] WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Имя, Телефон, Имейл FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_id, string Original_Имя, string Original_Телефон, string Original_Имейл) {
        ...
        public virtual int Insert(int id, string Имя, string Телефон, string Имейл) {
        ...
        public virtual int Update(int id, string Имя, string Телефон, string Имейл, int Original_id, string Original_Имя, string Original_Телефон, string Original_Имейл) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Имя, string Телефон, string Имейл, int Original_id, string Original_Имя, string Original_Телефон, string Original_Имейл) {
            return this.Update(Original_id, Имя, Телефон, Имейл, Original_id, Original_Имя, Original_Телефон, Original_Имейл);
        }
    }
